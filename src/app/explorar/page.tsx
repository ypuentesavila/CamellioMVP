      ...
      <div className="max-w-2xl mx-auto px-4 pt-5">
        {loading ? (
          ...
          <EmptyState
            ...
            description={query || activeCategory ? "Intenta con otros filtros o amplía la búsqueda." : "Pronto habrá trabajadores disponibles en tu zona."}
            action={
              query || activeCategory
                ? { label: "Limpiar filtros", onClick: () => { setQuery(""); setActiveCategory(null); }, variant: "outline" }
                : undefined
            }
          />
        ) : (
          <>
            <p className="text-xs text-stone-400 mb-4">
              ...
              {activeCategory && <> en <span className="font-semibold text-stone-600">{CATEGORY_NAMES[activeCategory]}</span></>}
            </p>
